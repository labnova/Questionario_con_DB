...
function calcolaMedia($pun) {
	...
	$domanda= "SELECT domanda.*, risposta.* ";
...
<section>
	...
	<div  class='domanda'><?php  echo $row["domanda"]; ?></div>
	<ul>
    	<li><input  type='radio' name='domanda[<? echo $id; ?>]' value='rispostaEsatta' /><label>
    	<? echo $row['rispostaEsatta']; ?></label></li><br/>

		


		<li><input  type='radio'  name='domanda[<? echo $id; ?>]'  value='risposta1' /><label><? echo $row['risposta1']; ?></label></li><br/>
		<li><input  type='radio'  name='domanda[<? echo $id; ?>]'  value='risposta2' /><label><? echo $row['risposta2']; ?></label></li><br/>
		<li><input type='radio'  name='domanda[<? echo $id; ?>]'  value='risposta3' /><label><? echo $row['risposta3']; ?></label></li><br/>
</ul>
...
//$risposta=implode(",", $_POST['domanda']);



foreach($risposta as $risp) {
...
switch ($risp) {
		...
		case 'risposta1':
			...
			echo "<br/><p class='sbaglio'>".$row['spiegazione1']. "</p><br/>";
			
			break;

			case 'risposta2':
			
			echo "<br/><p class='sbaglio'>".$row['spiegazione2']. "</p><br/>";
			
			break;

			case 'risposta3':
			
			echo "<br/><p class='sbaglio'>".$row['spiegazione3']. "</p><br/>";
			
			break;

			case 'rispostaEsatta':
			
			echo "<br/><p class='giusto'>bravo, dannazione!</p><br/>";
			break;
